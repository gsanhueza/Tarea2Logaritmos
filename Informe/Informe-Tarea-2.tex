...
% 	// TODO: Verificar si los tiempos están acotados o se fueron a la chu*** cada vez que aumentamos el número
	...
	idea original de la implementación de búsqueda, la cual consistía en % TODO Chamullar la idea de construcción del Suffix Tree
	...
	% IF NOT DONE
	Dado que no se pudo completar la búsqueda dentro del Suffix Tree, tenemos que analizarla teóricamente: % TODO Análisis teórico de búsqueda del Suffix Tree
